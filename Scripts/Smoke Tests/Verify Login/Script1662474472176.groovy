...
WebUI.waitForElementPresent(findTestObject('Page_Overview/cb_logo'), 10)

if (WebUI.getUrl() == 'https://test-automation-do-not-use.dev-connectboosterportal.com/platform/portal/overview') {
} else {
